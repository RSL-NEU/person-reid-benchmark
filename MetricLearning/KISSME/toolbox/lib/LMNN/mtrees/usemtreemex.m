function [iknn,dists]=usemtreemex(xtest,xtrain,tree,k);
...
dim=size(tree.piv,1);
[iknn,dists]=findknnmtree(xtrain(1:dim,tree.index),xtest(1:dim,:),k,tree.piv,tree.radius,tree.jumpindex,tree.kids);
