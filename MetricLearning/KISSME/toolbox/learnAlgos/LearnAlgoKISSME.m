...
classdef LearnAlgoKISSME < LearnAlgo
    ...
    methods
        ...
        function s = learnPairwise(obj,X,idxa,idxb,matches)
            ...
            covMatches=(1-beta)*covMatches+beta*eye(size(covMatches))*trace(covMatches)/size(X,2);
            ...
            covNonMatches=(1-beta)*covNonMatches+beta*eye(size(covNonMatches))*trace(covNonMatches)/size(X,2);
            t = toc;
